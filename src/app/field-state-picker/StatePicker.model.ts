export class StatePicker{
  constructor(public selectedCountry: string, public selectedState: string, public states: Array<string>) {
    this.selectedCountry = selectedCountry;
    this.selectedState = selectedState;
    if(selectedCountry != null) {
      this.states = this.getStates(selectedCountry);
    }else{
      this.states = null;
    }
  }
  ...
  public onCountryChanged(newCountry: string){
    this.selectedState = null;
    this.selectedCountry = newCountry;
    this.states = this.getStates(newCountry);
  }

  public getStates(country: string):Array<string>{
    return this.allStates[country];
}
//  countries = new Array();
//
